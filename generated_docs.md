...
*   **Damage Dice**: The default damage dice is .
...
*   **Healing Dice**: The default healing dice is .
...
*   **Distance**: The target will move 0 meter by default.
...
The Enact Persistent Effect applies a lingering effect to a target, such as fire, frost, or poison damage. By default, the effect lasts for 0 rounds and triggers at either the start of the target's turn or the end of the engager's turn.

## Rules

*   **Duration**: Lasts 0 rounds by default.
...
_No effect options available._
...
Enact Negation allows characters to reduce incomming damage by default by . This can also be used to remove a Persistant Effect.

## Rules

*   **Negate Dice**: The default Negate roll is .
...
While this document refers to a “magic system” for convenience, the world of SAS does **not** necessarily recognize these mechanics as magic. Instead, they are understood as natural phenomena that can be observed, measured, and manipulated.
...
This document explains the foundational concepts of the system and how spells or effects can be constructed within the rules of SAS.

:::warning Although this document describes a “magic system”, this does **not** mean the world of SAS perceives these effects as magic. :::
...
| Term | Description |
| --- | --- |
| **Mantles** | Fundamental particles that surround atoms. Mantles form the medium through which interaction with matter occurs. |
| **Resonance Slices** | Discrete components of an interaction profile. Mantles react to specific Resonance Slices. |
| **Aggregate** | A coherent collection of raw Mantles not bound to atoms. Souls and Spirits are both types of Aggregates. |
| **Soul** | A Aggregate that resides within and is bound to a physical body. |
| **Spirit** | A Aggregate composed entirely of raw Mantles, not bound to a physical body. |
| **Body** | A living physical vessel that contains a Soul. |
| **Resonance Signature** | A unique, immutable pattern of Resonance Slices emitted by a Aggregate. Comparable to a fingerprint. |
| **Response Profile** | A material-defined interaction profile describing how Mantles respond to incoming Resonance Slices. |

---

## Mantles

Atoms exist everywhere in the world of SAS.  
Each atom is surrounded by **Mantles**, which act as an interaction layer between matter and external influence.

Mantles can attach, merge, move, or otherwise interact with atoms, but only when stimulated by compatible Resonance Slices.

Below is a schematic representation of an iron atom. The outer ring represents its Mantles.
...
Because Mantles are bound to atoms, they only respond to Resonance Slices that match the material they surround.

:::info This can be visualized as color matching.

Each material has its own “color”.  
A leaf may resonate at a purple profile.  
By generating Resonance Slices that match this profile, interaction becomes possible.

The exact Resonance Slices required depend entirely on the material. :::

---

## Resonance Signature

Every Aggregate emits a **Resonance Signature**.  
This signature is a unique and immutable combination of Resonance Slices, comparable to a fingerprint.

Resonance Signatures are emitted passively and continuously. Because of this, they are sometimes referred to as **send profiles**.
...
*   A slice at **\-4** may represent affinity with water
*   A slice at **\-2** may represent air
*   A slice at **4** may represent fire

Resonance Slices blend into one another. A value such as **\-4.156** could represent a compound interaction, such as saltwater.

Aggregates with strong resonance in a specific slice naturally have an affinity for related materials or effects.

---

## Response Profiles

**Response Profiles** are similar in structure to Resonance Signatures, but they apply to **materials**, not Aggregates.

Unlike Resonance Signatures:

*   Response Profiles are **not unique**
*   All instances of the same material share the same Response Profile

Response Profiles describe how Mantles will react when stimulated.
...
If a Aggregate generates Resonance Slices that sufficiently match the heat slice in wood’s Response Profile, the Mantles around the wood atom will react — causing the wood to ignite.

---

## Resonance Slices

Resonance Slices represent discrete interaction domains.  
Mantles react only to specific slices.
...
To interact with a phenomenon, a Aggregate must generate Resonance Slices that closely match the required pattern.
...
A **Soul** is a Aggregate bound to a physical body.  
It relies on the body for stability and interaction with the physical world.

### Spirits

A **Spirit** is a Aggregate not bound to a physical body.  
It exists entirely as a self-sustaining structure of Mantles.
