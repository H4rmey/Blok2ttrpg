...
**Specific States**: States that impact something other then the Traits, like action economie or character behaviour. For example: When you are stunned you lose one of your actions. When you are aggrowed, you may only attack one preset Target.
...
| :--- | :--- |
| **Aggravated** | You can only target a preset Target. |
...
| **Distracted** | If you change your current target to a new one, your rolls will shift one down. |
...
| **Insane** | At the start of your turn, roll a dice (d4) to determine if you double damage, attack, skip your turn, or hit yourself. |
