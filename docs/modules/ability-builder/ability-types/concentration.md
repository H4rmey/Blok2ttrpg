...
*   **Initial Cost**: Costs {{.Concentration.BaseAction}} Actions and {{.Concentration.BaseEnergy}} Energy to initiate.
*   **Upkeep Cost**: At the start of your turn, you must spend either {{.Concentration.BaseUpkeepAction}} Action or {{.Concentration.BaseUpkeepEnergy}} Energy to maintain the Concentration. If you cannot (or choose not to) pay this upkeep, the Ability ends immediately.
...
{{.ConcentrationPerksTable}}

## Compatible Enactments

{{.ConcentrationEnactmentsTable}}
...
ability:
  ...
  energy_cost: {{.Concentration.BaseEnergy}}
  action_cost: {{.Concentration.BaseAction}}
  upkeep_cost: {{.Concentration.BaseUpkeepAction}} Action or {{.Concentration.BaseUpkeepEnergy}} Energy
  enactments:
    - Type:
  perks:
```
